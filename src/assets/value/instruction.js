...
![language](http://0.0.0.0:8000/language.jpg)

1.显示/隐藏顶栏和关闭eHunter
![topbar_close](http://0.0.0.0:8000/topbar_close.jpg)

2.在页面右上角点击打开eHunter
![open_ehunter](http://0.0.0.0:8000/open_ehunter.jpg)

3.在\`阅读模式\`为\`书本\`时, 可使用键盘的左右键翻页
![keyboard_arrow](http://0.0.0.0:8000/keyboard_arrow.jpg)
